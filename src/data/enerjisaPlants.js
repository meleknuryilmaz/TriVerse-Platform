...
const ENERJISA_PLANTS = [
  ...
  { id: 'hes-02', name: 'Çambaşı HES',        type: 'HES', lat: 40.7500, lon: 40.2500, mw: 5,     turbines: null, il: 'Trabzon',      status: 'active', desc: 'Trabzon sularından faydalanan, doğayla uyumlu nehir tipi (regülatör) küçük hidroelektrik tesisimiz.' },
  { id: 'hes-03', name: 'Dağdelen HES',       type: 'HES', lat: 37.8500, lon: 36.8500, mw: 6.4,   turbines: null, il: 'Kahramanmaraş',status: 'active', desc: 'Bölgedeki su akış rejimini dengeleyerek elektrik üreten, şebekeye baz yük sağlayan aktif nehir tipi barajımız.' },
  { id: 'hes-04', name: 'Doğançay HES',       type: 'HES', lat: 37.6000, lon: 35.5000, mw: 8,     turbines: null, il: 'Adana',        status: 'active', desc: 'Adana bölgesinde tarım alanlarına zarar vermeden enerji üreten sürdürülebilir su yönetimi projesi.' },
